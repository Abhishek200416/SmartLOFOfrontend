...
const ReportFound = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Found item reported successfully! AI is finding potential owners...');
      navigate('/my-items');
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-[#020617]" data-testid="report-found-page">
      <Navbar />
      ...
      <div className="container mx-auto px-6 py-8 max-w-3xl">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">Report Found Item</h1>
          <p className="text-lg text-slate-400">Help someone find their lost belonging with AI-powered matching</p>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div data-testid="description-field">
              ...
              <Textarea
                id="description"
                placeholder="Describe the item... AI will also extract details from the image"
            ...
            <div data-testid="location-field">
              <Label htmlFor="location" className="text-slate-300 mb-2 block text-base">Location Found</Label>
